 ...
 */
export declare function createStreamFn(getProxyUrl: () => Promise<string | undefined>): (model: Model<any>, context: Context, options?: SimpleStreamOptions | undefined) => Promise<import("@mariozechner/pi-ai").AssistantMessageEventStream>;
