...
private mapping resolve_pending;
nosave string *months;

private mapping bad_cmd = BAD_CMD;
private mapping access_denied = ACCESS_DENIED;
private mapping not_found = NOT_FOUND;
private mapping bad_gateway = BAD_GATEWAY;
